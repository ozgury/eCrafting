...
var PermissionHelpers = {
  ...
  hasPermission:function (permission) {
    ...
    return function (user) {
      ...
      //console.log("Intersect Object", calipso.lib._);
      //console.log("Intersect Function", calipso.lib._.intersect);
      // Check if allowed based on intersection of user roles and roles that have permission
      var isAllowed = intersect(permissionRoles, userRoles).length > 0,
